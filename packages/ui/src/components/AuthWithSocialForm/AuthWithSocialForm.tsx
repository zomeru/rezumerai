 ...
 * @property googleAuth - Optional Google OAuth handler
 * @property githubAuth - Optional GitHub OAuth handler
 * @property appleAuth - Optional Apple OAuth handler
 *
 * @example
 * ```tsx
 * // With social auth
    ...
    <div className="mx-4 max-w-96 rounded-xl bg-white p-4 text-left text-gray-500 text-sm shadow-[0px_0px_10px_0px] shadow-black/10 md:p-6">
      ...
      {googleAuth && (
        <button
          ...
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-full border border-gray-500/30 bg-white py-2.5 text-gray-800 hover:bg-gray-50"
        >
      ...
      {githubAuth && (
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-full border border-gray-500/30 bg-white py-2.5 text-gray-800 hover:bg-gray-50"
        >
      ...
      {appleAuth && (
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-black py-2.5 text-white hover:bg-gray-900"
        >
