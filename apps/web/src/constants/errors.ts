export const ERROR_MESSAGES = {
  ...
  AI_CONFIG_INVALID_PAYLOAD: "Invalid AI configuration payload.",
  ...
  AI_CONFIG_UPDATE_FAILED: "Failed to update AI configuration.",
  AI_CONFIG_UPDATE_INVALID_RESPONSE: "Invalid AI configuration update response.",
  AI_PROMPT_VERSION_REQUIRED: "Prompt version is required.",
  AI_SYSTEM_PROMPT_REQUIRED: "Optimize system prompt is required.",
  AI_DAILY_LIMIT_INVALID: "Daily credit limit must be an integer between 1 and 1000.",
  ...
  AI_GLOBAL_CONFIG_UPDATED: "Global AI configuration updated.",
