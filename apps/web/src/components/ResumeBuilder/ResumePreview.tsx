        ...
        >
          ...
          {totalPages > 1 && isHovered && (
            <>
              <div className="absolute top-6 right-6 z-10 flex flex-col gap-2">
                {currentPage > 0 && (
                  <button
                    ...
                    className="flex size-10 items-center justify-center rounded-lg bg-linear-to-br from-white to-slate-50 shadow-xl ring-1 ring-slate-200/50 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:ring-slate-300/70 active:scale-95"
              ...
              {/* Page indicator */}
              <div className="absolute bottom-6 left-1/2 z-10 -translate-x-1/2 rounded-full bg-linear-to-r from-slate-900/90 to-slate-800/90 px-4 py-2 font-medium text-sm text-white shadow-lg ring-1 ring-white/10 backdrop-blur-md">
